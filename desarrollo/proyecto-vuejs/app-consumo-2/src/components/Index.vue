                ...
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <div class="card-body">
                            ...
                            <button class="btn btn-danger btn-sm ml-1" v-on:click="deletePropietario(estupropietariodiante)">Eliminar</button>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <p class="card-text">Edad: {{ propietario.cedula }}</p>
                            <p class="card-text">Nacionalidad: {{ propietario.correo }}</p>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <p  v-if="propietario.length == 0"> Sin Departamentos</p>
    </div>
</template>
<script>
